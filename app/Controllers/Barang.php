...
class Barang extends Controller
{
    ...
    public function add()
    {
        ...
        $model = new Barang_model;
        $data = array(
            'nama_barang' => $this->mRequest->getPost('nama'),
            'qty'         => $this->mRequest->getPost('qty'),
            'harga_beli'  => $this->mRequest->getPost('beli'),
            'harga_jual'  => $this->mRequest->getPost('jual')
        );
    ...
    {
        $model = new Barang_model;
        $id = $this->mRequest->getPost('id_barang');
        $data = array(
            'nama_barang' => $this->mRequest->getPost('nama'),
            'qty'         => $this->mRequest->getPost('qty'),
            'harga_beli'  => $this->mRequest->getPost('beli'),
